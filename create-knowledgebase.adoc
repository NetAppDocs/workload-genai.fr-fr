...
. Dans la mosaïque workloads d'IA, sélectionnez *Créer un Chatbot*.
. Dans l'onglet bases de connaissances, sélectionnez *Ajouter une base de connaissances*.
. Dans la page définir la base de connaissances, configurez les paramètres de la base de connaissances :
+
