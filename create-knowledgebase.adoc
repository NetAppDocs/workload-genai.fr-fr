...
.. *Modèle Chat*: Choisissez parmi les modèles Anthropique Claude ou Amazon Nova Chat qui sont intégrés dans Amazon Bedrock. Notez que vous devez avoir déjà activé le modèle de chat à partir d'Amazon Bedrock.
+
